 ...
 * BubblyPrivacyPage
 *
 * Privacy policy for the Bubbly app (/bubbly/privacy).
 * Content is rendered from the original legal HTML via dangerouslySetInnerHTML.
 * Styles are provided by BubblyLayout (bubbly.css).
 */
...
const html = `
  ...
  <div class="docs-container">
    ...
    <p>
      This privacy notice for App Team Carolina ("<b>Company</b>," "<b>we</b>,"
      "<b>us</b>," or "<b>our</b>"), describes how and why we might collect,
      store, use, and/or share ("<b>process</b>") your information when you use
      our services ("<b>Services</b>"), such as when you:
    </p>
    <ul>
      <li>
        Download and use our mobile application (Bubbly - CVI Literacy), or any
    ...
    <p>
      ...
      <a href="mailto:dev@appteamcarolina.com">dev@appteamcarolina.com</a>.
    </p>
    ...
    <p>
      <b>In what situations and with which parties do we share personal
        information?
      </b>
    ...
    <p>
      ...
      <a href="https://app.termly.io/notify/6fcf438a-4ff3-4286-aa74-6ba0615218be">here</a>, or by contacting us. We will consider and act upon any request in
    ...
    <p>
      <i><b>In Short: </b>We collect personal information that you provide to
        us.</i>
    </p>
    <p>
    ...
    <p>
      <i><b>In Short: </b>We process your information to provide, improve, and
        administer our Services, communicate with you, for security and fraud
        prevention, and to comply with law. We may also process your information
        for other purposes with your consent.</i>
    </p>
    <p>
    ...
    <ul>
      <li>
        <b>To save or protect an individual's vital interest. </b>We may process
    ...
    <p>
      <i><b>In Short: </b>We only process your personal information when we
    ...
    <p>
      <b><u><i>If you are located in the EU or UK, this section applies to you.</i></u></b>
    </p>
    <p>
    ...
    <p>
      <b><u><i>If you are located in Canada, this section applies to you.</i></u></b>
    </p>
    <p>
    ...
    <p>
      <i><b>In Short: </b>We may share information in specific situations
        described in this section and/or with the following third parties.</i>
    </p>
    <p>
    ...
    <p>
      <i><b>In Short: </b>We keep your information for as long as necessary to
    ...
    <p>
      <i><b>In Short: </b>In some regions, such as the European Economic Area
        ...
        review, change, or terminate your account at any time.</i>
    </p>
    <p>
    ...
    <p>
      ...
      contact details
      <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.">here</a>.
    </p>
    <p>
    ...
    <p>
      <i><b>In Short: </b>Yes, if you are a resident of California, you are
    ...
    <p>
      ...
      <a href="mailto:dev@appteamcarolina.com">dev@appteamcarolina.com</a>, or
    ...
    <p>
      App Team Carolina has not disclosed or sold any personal information to
      third parties for a business or commercial purpose in the preceding twelve
      (12) months. App Team Carolina will not sell personal information in the
    ...
    <p>
      ...
      <a href="mailto:dev@appteamcarolina.com">dev@appteamcarolina.com</a>, or
      by referring to the contact details at the bottom of this document. If you
    ...
    <p>
      ...
      <a href="mailto:dev@appteamcarolina.com">dev@appteamcarolina.com</a> or by
      post to:
    </p>
    <p>
      App Team Carolina
      <br></br>
      2501 Fred Porter Graham Student Union Box 350
      <br></br>
    ...
    <p>
      ...
      <a href="https://app.termly.io/notify/6fcf438a-4ff3-4286-aa74-6ba0615218be">here</a>.
    </p>
  </div>
`

export default function BubblyPrivacyPage() {
  return (
    <div className="bubbly-root" dangerouslySetInnerHTML={{ __html: html }} />
  )
}

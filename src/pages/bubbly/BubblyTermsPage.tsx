 ...
 * BubblyTermsPage
 *
 * Terms and Conditions for the Bubbly app (/bubbly/terms).
  ...
  <div class="docs-container">
    ...
    <ul>
      <li>
        ...
        Company downloaded by You on any electronic device, named Bubbly - CVI
        Literacy
      </li>
      <li>
        <strong>Application Stor</strong>e means the digital distribution
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to App Team Carolina, 201 S
        Columbia St, Chapel Hill, NC 27599.
      </li>
      <li>
      ...
      <il><strong>You</strong> means the individual accessing or using the
        Service, or the company, or other legal entity on behalf of which such
        individual is accessing or using the Service, as applicable.</il>
    </ul>
    ...
    <p>
      ...
      use of the Service. <br></br><br></br>
...
export default function BubblyTermsPage() {
  return (

...
type HeroGeometricProps = {
  ...
  shapeGradients?: [string, string, string, string, string];
};
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          height={40}
          rotate={-25}
          gradient={shapeGradients[4]}
          className="left-[20%] top-[5%] md:left-[25%] md:top-[10%]"
        />
      </div>

      <div className="relative z-10 container mx-auto px-4 pt-20 md:px-6 md:pt-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <Circle className="h-2.5 w-2.5 fill-rose-500/80 text-rose-500/80" />
            <span className="text-sm tracking-[0.18em] text-white/60 uppercase">
              {badge}
            </span>
          </motion.div>
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="mx-auto mb-8 max-w-2xl px-4 text-base leading-relaxed font-light tracking-wide text-white/50 sm:text-lg md:text-xl">
              {description}
            </p>
          </motion.div>
